...
AFTER INSERT
AS
  INSERT INTO SIOPEL_INTERFACE_DB.siopel_owner.swoper_sync (clave, CODIGODERE, FECHA, HORA, NUMEROSECU, codigodeti, cupon, numerocupo, plazoopera, moneda, tipo, codigoagen, codigoage2, CANTIDADOP, PRECIOOPER, PRECIOREFE, TOPEBASE, FLOTACION, operaciono,
